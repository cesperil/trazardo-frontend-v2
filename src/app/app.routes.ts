...
export const routes: Routes = [
  ...
  { path: 'finca-selection', component: FincaSelectionComponent, data: { breadcrumb: 'Finca Selection' } },
  { path: 'consulta-lotes', component: ConsultaLotesComponent, data: { breadcrumb: 'Consulta Lotes' } },
  { path: 'crear-lote', component: CrearLoteComponent, data: { breadcrumb: 'Crear Lote' } },
  { path: 'detalle-lote', component: DetalleLoteComponent, data: { breadcrumb: 'Detalle Lote' } },
  { path: 'gestion-explotaciones', component: GestionExplotacionesComponent, data: { breadcrumb: 'Gestión Explotaciones' } },
  ...
  { path: 'gestion-usuarios', component: GestionUsuariosComponent, data: { breadcrumb: 'Gestión Usuarios' } },
  { path: 'gestion-ganaderos', component: GestionGanaderosComponent, data: { breadcrumb: 'Gestión Ganaderos' } },
  ...
  { path: 'gestion-tecnicos', component: GestionTecnicosComponent, data: { breadcrumb: 'Gestión Técnicos' } },
  ...
  { path: 'entrada-montanera/nuevo-entrada-montanera', component: NuevoEntradaMontaneraComponent, data: { breadcrumb: 'Nuevo Entrada Montanera' } },
  ...
  { path: 'gestion-lotes-admin', component: GestionLotesAdminComponent, data: { breadcrumb: 'Gestión Lotes Admin' } },
